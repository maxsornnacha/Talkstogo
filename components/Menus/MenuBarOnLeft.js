import { faHouse, faUserGroup, faVolumeHigh } from "@fortawesome/free-solid-svg-icons"
...
export default function MenuBarOnNavbar(props){
    ...
    useEffect(()=>{
        if(currentContactLoading && CurrentRoomLoading){
            props.MenuBarOnLoadingStatus();
        }

    },[currentContactLoading , CurrentRoomLoading])


    return(
    <>
    <div className="flex flex-col items-start text-white bg-[#161617]  font-semibold w-[220px] ">
