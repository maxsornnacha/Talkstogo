...
export default function ChatroomMenuMobile({senderData,getterData,handleCloseChat,userData}){
    ...
    return(      
        <div 
        className={`chat-card-menu-mobile p-0 m-0 bg-[#050111] text-white`}
        ...
        >
            ...
            <div ref={chatRef} className="md:h-[370px] h-[86dvh]  bg-stone-900 w-full scrollbar-hide overflow-y-scroll">
